...
@NamedQuery(name = "User.findAllUsers", query = "select new com.ay.restaurant.dto.UserDto(u.id,u.name,u.email,u.contactNumber,u.status,u.role, u.address) from User u where u.role='user'")
